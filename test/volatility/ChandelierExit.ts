...
// Deno.test('ChandelierExit', function() {
//   Deno.test('should calculate ChandelierExit using the calculate method', function() {
//     assertEquals(ChandelierExit.calculate(input), expectResult, 'Wrong Results');
//   });

//   Deno.test('should be able to calculate ChandelierExit by using getResult', function() {
//     let chandelierexit = new ChandelierExit(input);
//     assertEquals(chandelierexit.getResult(),  expectResult, 'Wrong Results while calculating next bar');
//   });

//   Deno.test('should be able to get ChandelierExit for the next bar using nextValue', function() {
...
//   Deno.test('should be able to calculate ChandelierExit for reversed input by using calculate method', function() {
...
//     assertEquals(ChandelierExit.calculate(myInput),  expectResult.slice().reverse(), 'Wrong Results while calculating next bar');
//   });
// })
