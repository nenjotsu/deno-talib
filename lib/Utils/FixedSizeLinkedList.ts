...
size: any;
maintainHigh: undefined;
maintainLow: undefined;
maintainSum: undefined;
totalPushed: number;
periodHigh: number;
periodLow: number;
periodSum: number;
_push: (data: any) => void;
lastShift: any;
    constructor(size: any, maintainHigh?: undefined, maintainLow?: undefined, maintainSum?: undefined) {
        super();
        this.size = size;
